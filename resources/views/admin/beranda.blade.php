...
<div class="alert alert-success" role="alert">
					...
					<p>Selamat datang di halaman admin Pasar Online Dharma Wanita Persatuan (DWP) Kabupaten Madiun. Halaman ini berfungsi untuk memantau semua barang yang ditampilkan oleh penjual pada halaman website.</p>
					<hr>
							...
							<div class="bg-white pd-20 box-shadow border-radius-5">
								<div class="project-info clearfix">
									...
									<div class="project-info-right">
										...
										<p class="weight-400 font-18">JUMLAH PRODUK</p>
									</div>
								</div>
							</div>
						</div>
