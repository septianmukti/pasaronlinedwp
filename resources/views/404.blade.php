...
<head>
  ...
  <script src="{{ url('https://cdnjs.cloudflare.com/ajax/libs/modernizr/2.8.3/modernizr.min.js') }}" type="text/javascript"></script>
...
<div class="message-box">
  ...
  <div class="buttons-con">
    <div class="action-link-wrap">
      ...
      <a href="{{url('/')}}" class="link-button">Beranda</a>
    </div>
  </div>
</div>
